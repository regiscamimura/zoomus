...
client = ZoomClient('ACCOUNT_ID', 'CLIENT_ID', 'CLIENT_SECRET', base_uri="https://eu01api-www4local.zoom.us/v2")
```
...
client = ZoomClient('ACCOUNT_ID', 'CLIENT_ID', 'CLIENT_SECRET' version=1)
```

### Using with a manage context

```python
with ZoomClient('ACCOUNT_ID', 'CLIENT_ID') as client:
